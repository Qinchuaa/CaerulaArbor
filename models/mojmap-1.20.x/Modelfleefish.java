...
public class Modelfleefish<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "fleefish"), "main");
	private final ModelPart thrower;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition thrower = partdefinition.addOrReplaceChild("thrower",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.5F, -0.5F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 14)
						.addBox(-3.5F, -0.5F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.25F)),
