...
public class CaerulaArborModVillagerProfessions {
	...
	public static final RegistryObject<VillagerProfession> MYSTERIOUS_TRADER = registerProfession("mysterious_trader", () -> CaerulaArborModBlocks.EMERGENCY_LIGHT.get(),
			() -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.work_armorer")));
