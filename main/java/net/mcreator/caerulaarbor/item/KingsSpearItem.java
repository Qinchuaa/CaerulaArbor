...
import net.mcreator.caerulaarbor.procedures.PlaceSpearProcedure;
import net.mcreator.caerulaarbor.procedures.GainRelicSPEARProcedure;
...
public class KingsSpearItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		return PlaceSpearProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()), context.getPlayer(),
