...
import net.mcreator.caerulaarbor.procedures.RemoveMiningfatigueProcedure;
import net.mcreator.caerulaarbor.procedures.GainRelicSTAREProcedure;
...
public class GuardianStareItem extends Item {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		RemoveMiningfatigueProcedure.execute(entity);
	}
}
