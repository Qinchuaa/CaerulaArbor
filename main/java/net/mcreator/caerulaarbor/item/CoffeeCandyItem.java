...
import net.mcreator.caerulaarbor.procedures.GiveHasteIIProcedure;
...
public class CoffeeCandyItem extends Item {
	public CoffeeCandyItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.UNCOMMON).food((new FoodProperties.Builder()).nutrition(2).saturationMod(4f).build()));
	}
