...
import net.mcreator.caerulaarbor.procedures.EatMeatCanProcedure;
...
public class MeatCanItem extends Item {
	public MeatCanItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(14).saturationMod(16f).meat().build()));
	}
