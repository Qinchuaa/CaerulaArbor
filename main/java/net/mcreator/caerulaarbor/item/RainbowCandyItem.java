...
import net.mcreator.caerulaarbor.procedures.EatRainbowCandyProcedure;
...
public class RainbowCandyItem extends Item {
	public RainbowCandyItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.EPIC).food((new FoodProperties.Builder()).nutrition(6).saturationMod(3.2f).alwaysEat().build()));
	}
