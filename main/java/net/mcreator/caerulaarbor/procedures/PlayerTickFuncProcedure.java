...
public class PlayerTickFuncProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).disoclusion == 2) {
			if (!(entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(CaerulaArborModMobEffects.HAEMOPHILIA.get()))) {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.HAEMOPHILIA.get(), 299, 0, false, false));
			}
		} else {
			if (entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(CaerulaArborModMobEffects.HAEMOPHILIA.get())) {
				if (entity instanceof LivingEntity _entity)
					_entity.removeEffect(CaerulaArborModMobEffects.HAEMOPHILIA.get());
			}
		}
		modifi = 1;
		if (LightIsDimProcedure.execute(entity)) {
			modifi = modifi + 0.2;
		} else if (LightIsCeasedProcedure.execute(entity)) {
			modifi = modifi + 0.5;
		}
		if (entity instanceof LivingEntity _livingEntity4 && _livingEntity4.getAttributes().hasAttribute(CaerulaArborModAttributes.SANITY_MODIFIER.get()))
			_livingEntity4.getAttribute(CaerulaArborModAttributes.SANITY_MODIFIER.get()).setBaseValue(modifi);
		if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).player_lives <= 1) {
			...
			if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_king_SPEAR) {
				suitKing = suitKing + 1;
				if (!(entity instanceof LivingEntity _livEnt5 && _livEnt5.hasEffect(CaerulaArborModMobEffects.KINGS_BOOST.get()))) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.KINGS_BOOST.get(), 100, 1, false, false));
				}
			}
			...
			if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_king_CROWN) {
				suitKing = suitKing + 1;
				if (!(entity instanceof LivingEntity _livEnt10 && _livEnt10.hasEffect(CaerulaArborModMobEffects.KINGS_BREATH.get()))) {
					if (suitKing < 3) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.KINGS_BREATH.get(), 30, 0, false, false));
					} else {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.KINGS_BREATH.get(), 3, 2, false, false));
					}
				}
			}
		}
		if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_hand_SPEED
			...
			if (valid) {
				...
				if (!(entity instanceof LivingEntity _livEnt22 && _livEnt22.hasEffect(CaerulaArborModMobEffects.HANDS_SPEED.get()))) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.HANDS_SPEED.get(), 20, 2));
				}
			}
		}
		if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_hand_SWIPE) {
			if (!(entity instanceof LivingEntity _livEnt24 && _livEnt24.hasEffect(CaerulaArborModMobEffects.WIPE_DUSTS.get()))
					&& (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.BRUSH)) : false)) {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
		...
		if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).player_lives >= (entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_archfi_FLAG) {
				...
				if (!(entity instanceof LivingEntity _livEnt27 && _livEnt27.hasEffect(CaerulaArborModMobEffects.FLAG_SWINGS.get()))) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.FLAG_SWINGS.get(), 30, 2, false, false));
				}
			}
			if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_archfi_BED) {
				suitArchfi = suitArchfi + 1;
				if (!(entity instanceof LivingEntity _livEnt29 && _livEnt29.hasEffect(CaerulaArborModMobEffects.KEEP_BEDDING.get()))) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.KEEP_BEDDING.get(), 30, 0, false, false));
				}
			}
			if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_archfi_ARTIFACT) {
				suitArchfi = suitArchfi + 1;
				if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(CaerulaArborModMobEffects.SACREFICE.get()) ? _livEnt.getEffect(CaerulaArborModMobEffects.SACREFICE.get()).getDuration() : 0) < 5) {
					if (suitArchfi < 3) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.SACREFICE.get(), 30, 0, false, false));
					} else {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.SACREFICE.get(), 30, 2, false, false));
					}
				}
			}
		}
		if ((entity.getCapability(CaerulaArborModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CaerulaArborModVariables.PlayerVariables())).relic_hand_ENGRAVE > 0) {
			valid = false;
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.TRIDENT)) : false) {
				valid = true;
			} else {
				for (String stringiterator : CaerulaConfigsConfiguration.HAND_ENGRAVE.get()) {
					if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation((stringiterator).toLowerCase(java.util.Locale.ENGLISH))))) : false)
			...
			if (valid) {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.ENGRAVED_TRIUMPH.get(), 40,
		...
		if ((entity instanceof LivingEntity _livingEntity48 && _livingEntity48.getAttributes().hasAttribute(CaerulaArborModAttributes.SANITY.get()) ? _livingEntity48.getAttribute(CaerulaArborModAttributes.SANITY.get()).getBaseValue() : 0) > 1000) {
			if (entity instanceof LivingEntity _livingEntity49 && _livingEntity49.getAttributes().hasAttribute(CaerulaArborModAttributes.SANITY.get()))
				_livingEntity49.getAttribute(CaerulaArborModAttributes.SANITY.get()).setBaseValue(1000);
		}
		EquipComplexChitinProcedure.execute(entity);
		enchant = 0;
		...
		if (enchant > 0 && !(entity instanceof LivingEntity _livEnt66 && _livEnt66.hasEffect(CaerulaArborModMobEffects.SANIDY_DEFENDER.get()))) {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(CaerulaArborModMobEffects.SANIDY_DEFENDER.get(), 20, (int) (enchant - 1), false, false));
		}
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == CaerulaArborModItems.WEARABLE_CROWN_HELMET.get()) {
