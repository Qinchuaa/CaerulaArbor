...
import net.mcreator.caerulaarbor.procedures.InitReaperSanityProcedure;
import net.mcreator.caerulaarbor.procedures.GiveReaperBuffProcedure;
import net.mcreator.caerulaarbor.procedures.CanAttack3Procedure;
...
public class ReaperFishEntity extends Monster implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 0.6, true) {
			...
			public boolean canUse() {
				double x = ReaperFishEntity.this.getX();
				double y = ReaperFishEntity.this.getY();
				double z = ReaperFishEntity.this.getZ();
				Entity entity = ReaperFishEntity.this;
				Level world = ReaperFishEntity.this.level();
				return super.canUse() && CanAttack3Procedure.execute(entity);
			}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<>(this, "movement", 8, this::movementPredicate));
		data.add(new AnimationController<>(this, "attacking", 8, this::attackingPredicate));
		data.add(new AnimationController<>(this, "procedure", 8, this::procedurePredicate));
	}
