...
import com.apocalypse.caerulaarbor.procedures.RangedSettleProcedure;
...
public class UmbrellaSettleMobEffect extends MobEffect {
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		RangedSettleProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity);
	}
