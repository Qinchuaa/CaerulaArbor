...
public class UnicellularPredatorEntity extends SeaMonster {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, BoneSeaDrifterEntity.class, false, false));
        ...
        this.targetSelector.addGoal(9, new SeaMonsterAttackableTargetGoal<>(this, Player.class, false, false));
