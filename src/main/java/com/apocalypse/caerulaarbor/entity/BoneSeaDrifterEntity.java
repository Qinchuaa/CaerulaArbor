...
public class BoneSeaDrifterEntity extends SeaMonster {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(7, new NearestAttackableTargetGoal<>(this, Player.class, false, false) {
            ...
            public boolean canUse() {
                double x = BoneSeaDrifterEntity.this.getX();
                double y = BoneSeaDrifterEntity.this.getY();
                double z = BoneSeaDrifterEntity.this.getZ();
                Level world = BoneSeaDrifterEntity.this.level();
    ...
    public static void init() {
        SpawnPlacements.register(ModEntities.BONE_SEA_DRIFTER.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
