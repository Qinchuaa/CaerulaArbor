...
import com.apocalypse.caerulaarbor.procedures.SummonFakeEggProcedure;
import com.apocalypse.caerulaarbor.procedures.SummonFakeggOnblockProcedure;
...
public class FakerggShootEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		SummonFakeEggProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this.getOwner());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		SummonFakeggOnblockProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
