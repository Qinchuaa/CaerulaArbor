...
public class InfoStrategyAllScreen extends AbstractContainerScreen<InfoStrategyAllMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 37 && mouseX < leftPos + 95 && mouseY > topPos + 0 && mouseY < topPos + 44)
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("caerula_arbor:textures/screens/wetplayer.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 256, 168, 256, 168);

		guiGraphics.blit(new ResourceLocation("caerula_arbor:textures/screens/silence.png"), this.leftPos + -17, this.topPos + -18, Mth.clamp((int) GetStraSilenceProcedure.execute(world) * 29, 0, 116), 0, 29, 33, 145, 33);
	...
	public void init() {
		super.init();
		button_evolution_tree = new PlainTextButton(this.leftPos + 0, this.topPos + 169, 76, 20, Component.translatable("gui.caerula_arbor.info_strategy_all.button_evolution_tree"), e -> {
			if (true) {
		...
		imagebutton_grow_lit = new ImageButton(this.leftPos + 32, this.topPos + 0, 65, 47, 0, 0, 47, new ResourceLocation("caerula_arbor:textures/screens/atlas/imagebutton_grow_lit.png"), 65, 94, e -> {
			if (true) {
