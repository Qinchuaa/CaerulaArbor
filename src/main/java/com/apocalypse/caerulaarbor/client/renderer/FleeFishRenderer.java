...
import com.apocalypse.caerulaarbor.client.layer.FleeFishLayer;
import com.apocalypse.caerulaarbor.client.model.entity.FleeFishModel;
...
public class FleeFishRenderer extends GeoEntityRenderer<FleeFishEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FleeFishEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
