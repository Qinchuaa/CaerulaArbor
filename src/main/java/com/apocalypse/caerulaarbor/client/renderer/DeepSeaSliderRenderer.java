...
public class DeepSeaSliderRenderer extends GeoEntityRenderer<DeepSeaSliderEntity> {

    public DeepSeaSliderRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DeepSeaSliderModel());
