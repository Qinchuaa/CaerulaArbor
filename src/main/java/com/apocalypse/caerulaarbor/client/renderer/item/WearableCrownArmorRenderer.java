...
import com.apocalypse.caerulaarbor.client.model.item.WearableCrownModel;
import com.apocalypse.caerulaarbor.item.WearableCrownItem;

public class WearableCrownArmorRenderer extends GeoArmorRenderer<WearableCrownItem> {

    public WearableCrownArmorRenderer() {
        super(new WearableCrownModel());
    ...
    @Override
    public RenderType getRenderType(WearableCrownItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
