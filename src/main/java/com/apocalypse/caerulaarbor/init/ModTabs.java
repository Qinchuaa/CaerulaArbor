...
//				tabData.accept(CaerulaArborModItems.SCORE.get());
    ...
    public static final RegistryObject<CreativeModeTab> CAERULA_LIVINGS = REGISTRY.register("caerula_livings",
            () -> CreativeModeTab.builder().title(Component.translatable("item_group.caerula_arbor.caerula_livings")).icon(() -> new ItemStack(ModItems.LUMINOUS_CORPSE.get())).displayItems((parameters, tabData) -> {
