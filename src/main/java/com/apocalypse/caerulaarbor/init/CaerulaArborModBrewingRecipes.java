...
public class CaerulaArborModBrewingRecipes implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		PotionUtils.setPotion(potion, Potions.AWKWARD);
		PotionUtils.setPotion(potion2, ModPotions.INST_SANITY.get());
		...
		PotionUtils.setPotion(potion, ModPotions.INST_SANITY.get());
		PotionUtils.setPotion(potion2, ModPotions.SANITY_CURE.get());
		brewingRecipes.add(factory.createBrewingRecipe(List.copyOf(ingredientStack), potion.copy(), potion2.copy()));
		ingredientStack.clear();
		ingredientStack.add(new ItemStack(Items.GLOWSTONE_DUST));
		PotionUtils.setPotion(potion, ModPotions.INST_SANITY.get());
		PotionUtils.setPotion(potion2, ModPotions.INST_SANITY_II.get());
		brewingRecipes.add(factory.createBrewingRecipe(List.copyOf(ingredientStack), potion.copy(), potion2.copy()));
		ingredientStack.clear();
		ingredientStack.add(new ItemStack(Items.GLOWSTONE_DUST));
		PotionUtils.setPotion(potion, ModPotions.SANITY_CURE.get());
		PotionUtils.setPotion(potion2, ModPotions.SANITY_CURE_II.get());
		brewingRecipes.add(factory.createBrewingRecipe(List.copyOf(ingredientStack), potion.copy(), potion2.copy()));
		ingredientStack.clear();
