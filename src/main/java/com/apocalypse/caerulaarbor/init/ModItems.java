...
public class ModItems {
    ...
    public static final RegistryObject<Item> GUIDE_ABYSSAL_SPAWN_EGG = SPAWN_EGGS.register("guide_abyssal_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.NETHERSEA_BRANDGUIDER, -13434778, -2056595, new Item.Properties()));
