...
public class ModItems {
    ...
    public static final RegistryObject<Item> HAND_OF_BARREN = ITEMS.register("hand_of_barren", HandOfBarrenItem::new);
    ...
    public static final RegistryObject<Item> OBISIDIAN_BALL = ITEMS.register("obisidian_ball", ObisidianBallItem::new);
