...
public class ModPotions {
    ...
    public static final RegistryObject<Potion> SANITY_IMMUE_POTION = REGISTRY.register("sanity_immue_potion", () -> new Potion(new MobEffectInstance(ModMobEffects.SANITY_IMMUNE.get(), 3600, 0, false, true)));
