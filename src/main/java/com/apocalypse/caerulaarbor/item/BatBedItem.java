...
import com.apocalypse.caerulaarbor.procedures.GainRelicBATBEDProcedure;
...
public class BatBedItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GainRelicBATBEDProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
