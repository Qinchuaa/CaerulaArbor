...
import com.apocalypse.caerulaarbor.procedures.GainRelicARTIFACTProcedure;
...
public class ArchfiendsArtifactItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GainRelicARTIFACTProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
