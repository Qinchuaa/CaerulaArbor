...
import com.apocalypse.caerulaarbor.procedures.GainRelicSpeedProcedure;
...
public class HandOfSpeedItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GainRelicSpeedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
