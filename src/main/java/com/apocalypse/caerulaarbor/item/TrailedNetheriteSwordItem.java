...
import com.apocalypse.caerulaarbor.procedures.NetherSwordAttackProcedure;
...
public class TrailedNetheriteSwordItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		NetherSwordAttackProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
		return retval;
	}
