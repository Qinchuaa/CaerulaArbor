...
public class ComplexChitinSwordItem extends SwordItem {
    ...
    public ComplexChitinSwordItem() {
        super(ModItemTier.COMPLEX_CHITIN, 2, -2.4f, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON));
    }
    ...
    public Multimap<Attribute, AttributeModifier> getDefaultAttributeModifiers(EquipmentSlot pEquipmentSlot) {
        ...
        if (pEquipmentSlot == EquipmentSlot.MAINHAND) {
            ...
            map.put(ModAttributes.SANITY_INJURY_DAMAGE.get(),
                    new AttributeModifier(uuid, CaerulaArborMod.ATTRIBUTE_MODIFIER, 120, AttributeModifier.Operation.ADDITION));
        }
        return map;
    }
