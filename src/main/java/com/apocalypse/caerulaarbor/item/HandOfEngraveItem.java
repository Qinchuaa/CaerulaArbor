...
import com.apocalypse.caerulaarbor.procedures.GainRelicENGRAVEProcedure;
...
public class HandOfEngraveItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GainRelicENGRAVEProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
