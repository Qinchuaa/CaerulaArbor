...
import com.apocalypse.caerulaarbor.procedures.IronSwordAttackProcedure;
...
public class TrailedIronSwordItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		IronSwordAttackProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
		return retval;
	}
