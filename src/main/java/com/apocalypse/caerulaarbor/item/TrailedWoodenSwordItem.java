...
import com.apocalypse.caerulaarbor.procedures.WoodenSwordAtkProcedure;
...
public class TrailedWoodenSwordItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		WoodenSwordAtkProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
		return retval;
	}
