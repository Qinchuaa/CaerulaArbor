...
import com.apocalypse.caerulaarbor.procedures.StoneSwordAttackProcedure;
...
public class TrailedStoneSwordItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		StoneSwordAttackProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
		return retval;
	}
