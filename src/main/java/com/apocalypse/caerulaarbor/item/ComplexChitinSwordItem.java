...
import com.apocalypse.caerulaarbor.procedures.CauseSanityProcedure;
...
public class ComplexChitinSwordItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		CauseSanityProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity);
		return retval;
	}
