...
import net.mcreator.caerulaarbor.procedures.OpenStraSubsisProcedure;
import net.mcreator.caerulaarbor.procedures.OpenStraMigraProcedure;
import net.mcreator.caerulaarbor.procedures.OpenStraGrowProcedure;
import net.mcreator.caerulaarbor.procedures.OpenStraBreedProcedure;
import net.mcreator.caerulaarbor.procedures.OpenEvoTreeProcedure;
...
public class InfoStrategyAllButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = InfoStrategyAllMenu.guistate;
		...
		if (buttonID == 3) {
			...
			OpenStraMigraProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 4) {

			OpenStraSubsisProcedure.execute(world, x, y, z, entity);
		}
	}
