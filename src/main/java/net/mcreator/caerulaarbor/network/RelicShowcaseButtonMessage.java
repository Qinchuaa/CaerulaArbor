...
import net.mcreator.caerulaarbor.procedures.UngainRelicSPEARProcedure;
import net.mcreator.caerulaarbor.procedures.UngainRelicEXTENProcedure;
import net.mcreator.caerulaarbor.procedures.UngainRelicCrownProcedure;
import net.mcreator.caerulaarbor.procedures.UngainRelicCRYSTALProcedure;
import net.mcreator.caerulaarbor.procedures.UngainRelicARMORProcedure;
import net.mcreator.caerulaarbor.procedures.UngainHandThornsProcedure;
import net.mcreator.caerulaarbor.procedures.UngainHandStrangleProcedure;
import net.mcreator.caerulaarbor.procedures.UngainHandSpeedProcedure;
import net.mcreator.caerulaarbor.procedures.UngainHandSWIPEProcedure;
import net.mcreator.caerulaarbor.procedures.UngainHandFERTILITYProcedure;
import net.mcreator.caerulaarbor.procedures.UngainHandBARRENProcedure;
import net.mcreator.caerulaarbor.procedures.UngainCursedResearchProcedure;
import net.mcreator.caerulaarbor.procedures.UngainCursedGlowbodyProcedure;
import net.mcreator.caerulaarbor.procedures.UngainCursedEMELIGHTProcedure;
import net.mcreator.caerulaarbor.procedures.InnerOpenCaerulaProcedure;
