...
import net.mcreator.caerulaarbor.procedures.StandingofTrailProcedure;
import net.mcreator.caerulaarbor.procedures.RangedPalmProcedure;
import net.mcreator.caerulaarbor.procedures.OceanizedPlayerProcedure;
import net.mcreator.caerulaarbor.procedures.ModGriefSettingsProcedure;
...
public class CrackerAbyssalEntity extends Monster implements GeoEntity {
	...
	public void baseTick() {
		super.baseTick();
		StandingofTrailProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
