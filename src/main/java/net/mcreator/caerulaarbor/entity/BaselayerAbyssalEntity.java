...
import net.mcreator.caerulaarbor.procedures.LayTrailProcedure;
import net.mcreator.caerulaarbor.procedures.InitBaselayerSanityProcedure;
import net.mcreator.caerulaarbor.init.CaerulaArborModEntities;

import javax.annotation.Nullable;

public class BaselayerAbyssalEntity extends Monster implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, Player.class, false, false) {
			...
			public boolean canUse() {
				...
				Entity entity = BaselayerAbyssalEntity.this;
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		InitBaselayerSanityProcedure.execute(this);
		return retval;
	}
