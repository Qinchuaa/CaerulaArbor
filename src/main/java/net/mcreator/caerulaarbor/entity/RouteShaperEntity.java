...
import net.mcreator.caerulaarbor.procedures.RouteSkilladdProcedure;
import net.mcreator.caerulaarbor.procedures.OceanizedPlayerProcedure;
import net.mcreator.caerulaarbor.procedures.EraceFactalsProcedure;
import net.mcreator.caerulaarbor.procedures.DropRelicRouteProcedure;
...
public class RouteShaperEntity extends Monster implements GeoEntity {
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			...
			this.dropExperience();
			DropRelicRouteProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
		}
	}
