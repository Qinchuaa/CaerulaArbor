...
import net.mcreator.caerulaarbor.procedures.KeyUseProcedure;
import net.mcreator.caerulaarbor.procedures.GainRelicOMNIKEYProcedure;
...
public class OmniKeyItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GainRelicOMNIKEYProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
