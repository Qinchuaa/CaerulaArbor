...
import net.mcreator.caerulaarbor.procedures.GainCursedGLOWBODYProcedure;
import net.mcreator.caerulaarbor.procedures.EatGlowbodyProcedure;
...
public class RelicCursedGLOWBODYItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		EatGlowbodyProcedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		GainCursedGLOWBODYProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
	}
}
