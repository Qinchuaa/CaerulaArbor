...
import net.mcreator.caerulaarbor.procedures.BowUseProcedure;
import net.mcreator.caerulaarbor.item.renderer.PhloemBowItemRenderer;
...
public class PhloemBowItem extends Item implements GeoItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BowUseProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
