...
import net.mcreator.caerulaarbor.procedures.PlaceCrystalProcedure;
import net.mcreator.caerulaarbor.procedures.GainRelicCRYSTALProcedure;
...
public class KingsCrystalItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GainRelicCRYSTALProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
